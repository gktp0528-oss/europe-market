...
import { ArrowLeft, Heart, Share2, MessageCircle, MapPin, Clock, Eye, User, GraduationCap, BookOpen } from 'lucide-react-native';
                ...
                <View style={styles.content}>
                    ...
                    {meta.subject && (
                        <View style={styles.badgeRow}>
                            <View style={styles.badge}>
                                <BookOpen size={12} color="#B5EAD7" />
                                <Text style={styles.badgeText}>{meta.subject}</Text>
                            </View>
                            {meta.level && (
                                <View style={[styles.badge, { backgroundColor: '#E8E8E8' }]}>
                                    <Text style={[styles.badgeText, { color: '#6a6a6a' }]}>{meta.level}</Text>
                                </View>
                            )}
                        </View>
                    )}
                    ...
                    <View style={styles.infoCards}>
                        <View style={styles.infoCard}>
                            <GraduationCap size={18} color="#B5EAD7" />
                            <Text style={styles.infoLabel}>수업료</Text>
                            <Text style={styles.infoValue}>{post.price ? String(post.price) : '협의'}</Text>
                        </View>
                        <View style={styles.infoCard}>
...
const styles = StyleSheet.create({
    ...
    badge: {
        flexDirection: 'row', alignItems: 'center', backgroundColor: '#B5EAD720',
        paddingHorizontal: 10, paddingVertical: 5, borderRadius: 12, gap: 4,
    },
    badgeText: { fontSize: 12, fontWeight: '600', color: '#4A9E7E' },
