...
const ProductDetail = () => {
    ...
    const allItems = [
        { id: 1, title: '폴로 랄프로렌 셔츠', price: '30유로', location: '파리 15구', time: '10분 전', color: '#F5F5DC', views: 28, likes: 3, description: '폴로 랄프로렌 남성 셔츠입니다.\n사이즈: M\n상태: 거의 새것\n\n직거래 선호합니다.', seller: { name: '파리지앵', rating: 4.7, trades: 15 } },
        { id: 2, title: '빈티지 꽃무늬 원피스', price: '25유로', location: '마레지구', time: '30분 전', color: '#FFE4E1', views: 45, likes: 8, description: '빈티지 꽃무늬 원피스에요.\n사이즈: S-M\n\n마레지구에서 직거래 가능합니다!', seller: { name: '프랑스언니', rating: 4.9, trades: 42 } },
        { id: 3, title: '나이키 후드티', price: '20유로', location: '베를린 미테', time: '1시간 전', color: '#E6E6FA', views: 33, likes: 5, description: '나이키 기모 후드티입니다.\n사이즈: L\n색상: 그레이\n\n미테역 근처 직거래!', seller: { name: '베를린사는사람', rating: 4.5, trades: 8 } },
