...
const JobDetail = () => {
    ...
    const allJobs = [
        { id: 9, title: '부다페스트 한식당 주방보조', pay: '시급 2,500포린트', location: '부다페스트 6구', time: '20분 전', color: '#FFECB3', workHours: '주 3일 (금, 토, 일)', workTime: '18:00 - 22:00', requirements: '경력 무관, 한국인 우대', description: '부다페스트 6구에 위치한 한식당에서 주방보조 구합니다.\n\n📍 위치: 부다페스트 6구 안드라시 거리 근처\n⏰ 시간: 저녁 6시 - 10시\n💰 급여: 시급 2,500포린트 (당일 지급)\n\n✅ 담당 업무:\n- 설거지 및 주방 보조\n- 재료 손질 도움\n- 간단한 서빙\n\n관심 있으신 분은 채팅 주세요!', employer: { name: '서울식당', rating: 4.8, hires: 12 } },
        { id: 10, title: '온천 리조트 통역 알바', pay: '일당 40,000포린트', location: '부다페스트 14구', time: '2시간 전', color: '#B2EBF2', workHours: '주말 (토, 일)', workTime: '10:00 - 18:00', requirements: '영어/한국어 능통', description: '세체니 온천 근처 리조트에서 한국인 관광객 통역 알바 구합니다!\n\n🏨 근무지: 부다페스트 14구 온천 리조트\n📅 근무일: 주말 (토, 일)\n💰 급여: 일당 40,000포린트 + 점심 제공\n\n✅ 담당 업무:\n- 한국인 투숙객 체크인/아웃 통역\n- 스파 예약 안내\n- 간단한 관광 안내\n\n영어, 한국어 필수 / 헝가리어 가능시 우대!', employer: { name: '테르말호텔', rating: 4.9, hires: 8 } },
        { id: 11, title: '한인 게스트하우스 청소', pay: '시급 2,200포린트', location: '부다페스트 7구', time: '5시간 전', color: '#DCEDC8', workHours: '주 5일', workTime: '09:00 - 13:00', requirements: '성실한 분', description: '7구 위치 한인 게스트하우스에서 청소 알바 구합니다.\n\n🏠 근무지: 부다페스트 7구 (유대인 지구)\n⏰ 시간: 오전 9시 - 오후 1시\n💰 급여: 시급 2,200포린트\n\n✅ 담당 업무:\n- 객실 청소 및 침구 교체\n- 공용 공간 청소\n- 세탁물 정리\n\n장기 근무 가능하신 분 우대합니다!', employer: { name: '부다홈', rating: 4.6, hires: 5 } },
    ];
            ...
            <div className="detail-content">
                ...
                <div className="employer-card">
                    ...
                    <div className="employer-info">
                        ...
                        <span>⭐ {job.employer.rating} · 채용 {job.employer.hires}회</span>
                    </div>
                </div>
