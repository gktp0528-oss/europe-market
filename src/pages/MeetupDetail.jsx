...
const MeetupDetail = () => {
    ...
    const allMeetups = [
        { id: 9, title: '부다페스트 온천 투어', date: '2/11 (일)', location: '세체니 온천', time: '10분 전', color: '#80DEEA', meetTime: '오후 2시', participants: { current: 8, max: 12 }, fee: '무료 (입장료 별도)', description: '부다페스트의 유명한 온천들을 함께 둘러봐요! 🛁\n\n📅 일시: 2월 11일 (일) 오후 2시\n📍 집결지: 영웅광장 기둥 앞\n\n🗺️ 코스:\n1. 세체니 온천 (3시간)\n2. 바이다후냐드 성 구경\n3. 근처 카페에서 티타임\n\n💰 참가비: 무료!\n(온천 입장료 약 7,000포린트는 개별 결제)\n\n준비물: 수영복, 타월, 슬리퍼\n\n처음 오시는 분도 편하게 오세요~', host: { name: '온천러버', rating: 4.9, events: 23 } },
        { id: 10, title: '헝가리 와인 시음회', date: '2/17 (토)', location: '부다 성 근처', time: '2시간 전', color: '#CE93D8', meetTime: '오후 6시', participants: { current: 5, max: 8 }, fee: '15,000포린트', description: '헝가리 와인을 함께 즐겨요! 🍷\n\n📅 일시: 2월 17일 (토) 오후 6시\n📍 장소: 부다 성 근처 와인바\n\n🍇 시음 와인 (5종):\n- 토카이 아수 (디저트 와인)\n- 에게르 비카베르 (레드)\n- 에게르 케크프란코스\n- 빌라니 카베르네\n- 소믈로이 화이트\n\n💰 참가비: 15,000포린트\n(와인 5잔 + 안주 포함)\n\n정원 8명 선착순 마감!', host: { name: '와인홀릭', rating: 5.0, events: 15 } },
        { id: 11, title: '다뉴브강 야경 산책', date: '매주 금요일', location: '자유의 다리', time: '4시간 전', color: '#90CAF9', meetTime: '오후 8시', participants: { current: 12, max: 20 }, fee: '무료', description: '금요일 밤, 다뉴브강 야경과 함께 산책해요! 🌉\n\n📅 일시: 매주 금요일 오후 8시\n📍 집결지: 자유의 다리 페스트 쪽\n\n🚶 산책 코스 (약 1시간):\n자유의 다리 → 겔레르트 언덕 전망대 → 엘리자베스 다리 → 세체니 체인 브릿지\n\n💡 포인트:\n- 야경 사진 찍기 좋은 스팟들!\n- 마무리는 루인바에서 맥주 한 잔 🍺\n\n우천시 취소 (전날 공지)', host: { name: '부다산책러', rating: 4.8, events: 45 } },
    ];
            ...
            <div className="detail-content">
                ...
                <div className="host-card">
                    ...
                    <div className="host-info">
                        ...
                        <span>⭐ {meetup.host.rating} · 모임 {meetup.host.events}회 주최</span>
                    </div>
                </div>
